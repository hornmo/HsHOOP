...
CREATE TABLE IF NOT EXISTS `cars`.`model` (
  ...
  `fk_id_joining_process` INT(11) NOT NULL,
  `fk_id_stiffness_data` INT(11) NOT NULL,
  `fk_id_material_mix` INT(11) NOT NULL,
  `fk_id_production` INT(11) NOT NULL,
  `fk_id_production_sites` INT(11) NOT NULL,
  PRIMARY KEY (`id_model`),
  INDEX `fk_model_lengths1_idx` (`fk_id_lengths` ASC),
  INDEX `fk_model_weights1_idx` (`fk_id_weights` ASC),
  INDEX `fk_model_joining_process1_idx` (`fk_id_joining_process` ASC),
  INDEX `fk_model_stiffness_data1_idx` (`fk_id_stiffness_data` ASC),
  INDEX `fk_model_material_mix1_idx` (`fk_id_material_mix` ASC),
  INDEX `fk_model_production1_idx` (`fk_id_production` ASC),
  INDEX `fk_model_production_sites1_idx` (`fk_id_production_sites` ASC),
