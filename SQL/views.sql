...
CREATE VIEW `guest` 
	...
	AS SELECT m.manufacturer, m.name, m.model_year, m.generation, m.sop, m.segment, d.length, d.width, d.height, d.track_front, d.track_rear, d.wheelbase, w.total,
