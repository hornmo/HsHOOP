...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cars`.`joining_process` ;
...
-- Table `cars`.`lengths`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cars`.`lengths` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cars`.`manufacturer` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cars`.`material_mix` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cars`.`production` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cars`.`production_sites` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cars`.`stiffness_data` ;
...
-- Table `cars`.`weights`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cars`.`weights` ;
